...
echo 5. Probar flujo completo
echo 6. Probar sync Tienda Nube
echo 7. Sincronizar Tienda Nube
echo 8. Sincronizar imagenes Tienda Nube
echo 9. Editar config.toml
echo 10. Abrir carpeta exports
echo 11. Salir
echo.
